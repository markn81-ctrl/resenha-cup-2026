...
export function AppShell({
  ...
  return (
    <div className="mx-auto min-h-screen w-full max-w-7xl px-4 pb-28 pt-6 sm:px-6 lg:px-8">
      <header className="mb-6 flex flex-col gap-4">
        <div className="glass flex flex-col gap-5 rounded-[28px] px-5 py-5 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex min-w-0 items-center gap-4">
            <div className="shrink-0">
              {user?.image ? (
                ...
                <div className="flex h-14 w-14 items-center justify-center rounded-[20px] bg-brand-400 text-base font-bold text-slate-950">
          ...
          <div className="min-w-0 flex-1 lg:px-4">
            <p className="text-xs uppercase tracking-[0.28em] text-brand-200">Resenha Cup 2026</p>
            <h1 className="mt-1 font-[family-name:var(--font-heading)] text-3xl font-bold leading-tight">
              {title}
            </h1>
        ...
        <div className="grid gap-3 lg:grid-cols-[1fr_auto]">
          <nav className="glass flex flex-wrap items-center gap-2 rounded-[24px] p-3">
            <span className="px-2 text-xs font-semibold uppercase tracking-[0.24em] text-slate-500">
              Jogo
            </span>
            {playerNavigation.map((item) => (
              <Link
                ...
                href={item.href}
                className={cn(
                  "whitespace-nowrap rounded-2xl px-4 py-3 text-sm font-medium text-slate-300 transition hover:bg-white/5 hover:text-white",
          ...
          {user?.role === Role.ADMIN ? (
            <nav className="glass flex items-center gap-2 rounded-[24px] p-3">
              <span className="px-2 text-xs font-semibold uppercase tracking-[0.24em] text-slate-500">
                Administracao
              </span>
